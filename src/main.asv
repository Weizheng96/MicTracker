...
% dataPath = '/home/wei/Projects/MicTrackerMatab/Data/';
dataPath = '/home/wei/Projects/MicTrackerMatab/testData_small_Yinxue/';
logPath = '/home/wei/Projects/MicTrackerMatab/logs/';
outPath = '/home/wei/Projects/MicTrackerMatab/Results/';


% synQuantPath = '..\..\Seg3D_4Dissertation\src_code_cellSegment_cc\';
synQuantPath = '/home/wei/Projects/MicTrackerMatab/src/';
...
fmFileNameList = dir([dataPath,'*.tif']);
ImName = 'test';
...
%     fmName = ['prePrcssd_',ImName,'_t',num2str(t),'.tif'];
    fmName = ['',num2str(t),'.tif'];
    for z = 1:nZ
        imgFmRaw(:,:,z) = imread([dataPath,fmName], 'Index', z);
    end
    imgFmRaw = imgFmRaw(nY:-1:1,:,:);
